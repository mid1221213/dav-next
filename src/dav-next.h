...
#define     DEBUG0(log, err, str)                         ngx_log_debug3(NGX_LOG_DEBUG_ALL, log, err, "%s/%s:%d: " str, __FILE_NAME__, __FUNCTION__, __LINE__)
#define     DEBUG1(log, err, str, arg1)                   ngx_log_debug4(NGX_LOG_DEBUG_ALL, log, err, "%s/%s:%d: " str, __FILE_NAME__, __FUNCTION__, __LINE__, arg1)
#define     DEBUG2(log, err, str, arg1, arg2)             ngx_log_debug5(NGX_LOG_DEBUG_ALL, log, err, "%s/%s:%d: " str, __FILE_NAME__, __FUNCTION__, __LINE__, arg1, arg2)
#define     DEBUG3(log, err, str, arg1, arg2, arg3)       ngx_log_debug6(NGX_LOG_DEBUG_ALL, log, err, "%s/%s:%d: " str, __FILE_NAME__, __FUNCTION__, __LINE__, arg1, arg2, arg3)
#define     DEBUG4(log, err, str, arg1, arg2, arg3, arg4) ngx_log_debug7(NGX_LOG_DEBUG_ALL, log, err, "%s/%s:%d: " str, __FILE_NAME__, __FUNCTION__, __LINE__, arg1, arg2, arg3, arg4)

#define    ERROR_A(lvl, log, err, str, args...)           ngx_log_error(NGX_LOG_##lvl,       log, err, "%s/%s:%d: " str, __FILE_NAME__, __FUNCTION__, __LINE__, args)
#define      ERROR(lvl, log, err, str)                    ngx_log_error(NGX_LOG_##lvl,       log, err, "%s/%s:%d: " str, __FILE_NAME__, __FUNCTION__, __LINE__)

#define CF_ERROR_A(lvl, cf, err, str, args...)            ngx_conf_log_error(NGX_LOG_##lvl,   cf, err, "%s/%s:%d: " str, __FILE_NAME__, __FUNCTION__, __LINE__, args)
#define   CF_ERROR(lvl, cf, err, str)                     ngx_conf_log_error(NGX_LOG_##lvl,   cf, err, "%s/%s:%d: " str, __FILE_NAME__, __FUNCTION__, __LINE__)

#define QQ2(val) # val
#define QQ(val) QQ2(val)

#define NGX_STR_EQ(s1, s2)   ((s1)->len == (s2)->len && ngx_strncmp((s1)->data, (s2)->data, (s1)->len) == 0)
#define NGX_STR_CST_EQ(s, c) ((s)->len == sizeof((c)) - 1 && ngx_strncmp((s)->data, (c), sizeof((c)) - 1) == 0)
...
#define RETURN_CONF_ERROR_IF(expr, args...)                             \
    {                                                                   \
        if ((expr)) {                                                   \
            CF_ERROR_A(EMERG, cf, ngx_errno, args);                     \
